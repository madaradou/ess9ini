...
const userSchema = new mongoose.Schema({
  ...
  role: {
    ...
    default: CONSTANTS.USER_ROLES.FARMER
  },
  farmId: {
  ...
  profile: {
    ...
    preferences: {
      units: {
        type: String,
        enum: Object.values(CONSTANTS.UNITS),
        default: CONSTANTS.UNITS.METRIC
      },
      timezone: {
        type: String,
        default: CONSTANTS.TUNISIA.TIMEZONE
      },
      theme: {
        type: String,
        enum: Object.values(CONSTANTS.THEMES),
        default: CONSTANTS.THEMES.LIGHT
      },
      dashboardLayout: {
        type: String,
        default: 'default'
